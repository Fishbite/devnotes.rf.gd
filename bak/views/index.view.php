<main class="container">
  ...
  <article class="container">
    ...
    <section class="code-block">
      ...
      <pre><code class="language-php"><?=clean($example)?></code></pre>
    </section>
    ...
    <section class="code-block">
      ...
      <pre><code class="language-php"><?=clean($adminTrue)?></code></pre>
      <strong>
        <span>output:</span>
        <div class="output">
          <pre><code class="language-php"><?=clean($output)?></code></pre>
        </div>
      </strong>
    </section>
    ...
    <section class="code-block">
      ...
      <pre><code class="language-php"><?=clean($adminFalse)?></code></pre>
      <strong> <p>output:</p></strong>
      <div class="output">
        <pre><code class="language-php"><?=clean($adminFalseOutput)?></code></pre>
      </div>
    </section>

    <section class="code-block">
      <span>We can also chain <samp>if</samp> statements when we need to:</span>
      <pre><code class="language-php"><?=clean($chainIf)?></code></pre>
    </section>
    ...
    <section>
      ...
      <section class="code-block">
        ...
        <pre><code class="language-php"><?=clean($passwordEg)?></code></pre>
      </section>
    </section>
    ...
    <section>
      ...
      <section class="code-block">
        ...
        <pre><code class="language-php"><?=clean($variableValue)?></code></pre>
      </section>
    </section>
    ...
    <section>
      ...
      <section class="code-block">
        ...
        <pre><code class="language-php"><?=clean($stringsAndNumbers)?></code></pre>
      </section>
      ...
      <section class="code-block">
        ...
        <pre><code class="language-php"><?=clean($valueToVariableValue)?></code></pre>
      </section>
      <p>
    ...
    <section>
      ...
      <section class="code-block">
        ...
        <pre><code class="language-php"><?=clean($floats)?></code></pre>
      </section>
    ...
    <section>
      ...
      <section class="code-block">
        ...
        <pre><code class="language-php"><?=clean($embedBasic)?></code></pre>
      </section>
      ...
      <section class="code-block">
        ...
        <pre><code class="language-php"><?=clean($embed)?></code></pre>
      </section>
